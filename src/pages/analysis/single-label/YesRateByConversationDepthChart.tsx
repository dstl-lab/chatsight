...
type Props = {
  rows: SingleLabelRunDetail['by_conversation_depth']
}

const LABELS: Record<'short' | 'mid' | 'long', string> = {
  short: 'SHORT · 1–5',
  mid: 'MID · 6–15',
  long: 'LONG · 16+',
}

const ORDER: Array<'short' | 'mid' | 'long'> = ['short', 'mid', 'long']

export function YesRateByConversationDepthChart({ rows }: Props) {
